...
def generate_rss():
    ...
    base_url_template = "https://www.nature.com/search?q=%28topological%29+OR+%28phononic%29+OR+%28%22valley+hall%22%29+-%28metamaterials%29+-%28metamaterial%29+-%28metasurface%29+-%28metasurfaces%29&article_type=research%2C+reviews&subject={}&order=date_desc&date_range=2023-2025&journal=lsa%2Cnature%2Cnchem%2Cncomms%2Cnatelectron%2Cnmat%2Cnnano%2Cnphoton%2Cnphys%2Cnatrevphys%2Cnpjacoustics%2Cnpjqi%2Csrep&article_type=research%2C+reviews&page={}"
    ...
    # 自定义输出带换行符的 XML
    with open('nature_tp_pn_vh_ALL2325.xml', 'w', encoding='utf-8') as f:
    ...
    os.system("git add nature_tp_pn_vh_ALL2325.xml")
    os.system('git commit -m "Update nature_tp_pn_vh_ALL2325.xml with latest changes (all pages per subject, 2023-2025, research and reviews, multiple disciplines)"')

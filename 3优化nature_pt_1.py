...
def generate_rss():
    ...
    # 自定义输出带换行符的 XML
    with open('nature_pt_1.xml', 'w', encoding='utf-8') as f:
    ...
    os.system("git add nature_pt_1.xml")
    os.system('git commit -m "Update nature_pt_1.xml with latest changes (first 3 pages per subject, 2023-2025, research and reviews, multiple disciplines)"')
